...
S3_LOC=$S3_BUCKET/$S3_PATH/$INPUT_NAME/$YEAR/$MONTH
S3_LATEST_LOC=$S3_BUCKET/$S3_PATH/$INPUT_NAME
...
aws s3 cp s3://$S3_LOC/$S3_DB_DUMPFILE  s3://$S3_LATEST_LOC/$DESTLATEST
